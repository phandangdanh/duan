...
function updateDetailedStockDisplay(data) {
  ...
  if (mainStockElement) {
    mainStockElement.textContent = data.main_stock || 0;
  }
  
  if (variantStockElement) {
    variantStockElement.textContent = data.total_variant_stock || 0;
  }
  
  if (availableStockElement) {
    availableStockElement.textContent = data.total_stock || 0;
  }
