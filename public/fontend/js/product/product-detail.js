...
function setupColorOptions() {
  ...
  colorOptions.forEach(option => {
    option.addEventListener('click', function() {
      ...
      if (window.StockManagement && window.StockManagement.updateSizeOptions) {
        window.StockManagement.updateSizeOptions();
      }
      ...
      if (window.CartValidation && window.CartValidation.updateButtonState) {
        window.CartValidation.updateButtonState();
      }
    });
  });
}
...
function updateInitialState() {
  ...
  if (window.StockManagement && window.StockManagement.updateSizeOptionsState) {
    window.StockManagement.updateSizeOptionsState(null);
  }
}
...
window.ProductDetail = {
  ...
  getMainProductStock: () => mainProductStock
};
