...
class LocationService
{
    ...
    {
        $provinces = $this->locationRepository->getProvinces($search);
    ...
    {
        $districts = $this->locationRepository->getDistricts($provinceCode, $search);
    ...
    {
        $wards = $this->locationRepository->getWards($districtCode, $search);
    ...
    {
        $address = $this->locationRepository->getFullAddress($wardCode);
